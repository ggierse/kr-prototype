...
fixpointProto = Proto {identity = test, base = P0, add = Empty, remove = Empty}
protoUnfixed = Proto {identity = test, base=P0, add = Empty, remove = exampleChange}
protoUnfixed2 = Proto {identity = foo, base = iriToBase test, add=exampleChange, remove = Empty}
